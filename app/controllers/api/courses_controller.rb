class Api::CoursesController < ApplicationController
    ...
    def course_params
        params.require(:course).permit(:start_date, :end_date, :level, :instructor_id, :summary, :title, :topic_id, topics_attributes: [:name], availabilities_attributes: [:occurrence, :week_day, :length, :month_day, :start_time])
    end
end
